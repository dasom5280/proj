...
<body>
				...
				<div id="main">
					<form name="proFrm" method="post">
						<table>
							...
							<tr>
							<td colspan="2" rowspan="7"><img src="../admin/img_Product/<%=filename%>" alt=""
							...
							<% if(sale==1) out.println("<span style='color:red;'>[sale]</span>"); %>
							<%if(sale==1) {
							...
							<td>수량</td>
							<td>
							<input id="spinner" type="text" name="quantity" min="1" max="20" value="1" size="3"></td>
							</tr>
							<tr>
							<td>
							<input type="button" value="장바구니 담기" onclick="javascript:basketProc('<%=id%>')">
							</td>
							<td>
							<input type="button" value="바로구매" onclick="javascript:purchaseProc()">
							</td>
							</tr>
							<tr>
							<td><br></td>
	...
	function basketProc(id){
		...
		function purchaseProc() {
			document.proFrm.action = "purchaseProc.jsp";
			document.proFrm.submit();

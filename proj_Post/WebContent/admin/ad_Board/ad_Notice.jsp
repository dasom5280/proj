...
<jsp:useBean id="bMgr" class="pack_JDBC.Ad_BoardMgr" scope="page" />
<%
	...
	Vector<Ad_BoardBean> vlist = null;
		...
		<table class="listTbl">
			...
			<tr>
			 ...
			 <%
				...
				<td>
				<a href="ad_post.jsp" title="글쓰기">[글쓰기]</a> 
				<a href="ad_list.jsp" title="처음으로">[처음으로]</a>
				</td>
			</tr>
		</table>
		<hr>
		<form name="searchFrm" method="post" action="ad_list.jsp">
			<table>
				<tr>
					<td> <!--
					 	keyWord = "";

...
import pack_Bean.Ad_BoardBean;
import pack_DBCP.DBConnectionMgr;
import pack_Util.UtilMgr;

public class Ad_BoardMgr {
	...
	// 게시판 리스트
	public Vector<Ad_BoardBean> getBoardList(String keyField, String keyWord,
			int start, int end) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
		Vector<Ad_BoardBean> vlist = new Vector<Ad_BoardBean>();
		try {
			...
			if (keyWord.equals("null") || keyWord.equals("")) {
				...
				//////////// 페이징연습용 쿼리 시작 ////////////
				sql = "select * from tblBoard order by num desc limit 40, 50";
				//////////// 페이징연습용 쿼리 끝 ////////////
			...
			while (rs.next()) {
				Ad_BoardBean bean = new Ad_BoardBean();
	...
	// 게시물 리턴
	public Ad_BoardBean getBoard(int num) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	// 게시물 수정
	public void updateBoard(Ad_BoardBean bean) {
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		try {
	...
	// 게시물 답변
	public void replyBoard(Ad_BoardBean bean) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
